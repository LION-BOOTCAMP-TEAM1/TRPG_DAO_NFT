    ...
    <div className="flex flex-col">
      <div className="grid grid-cols-2 gap-1 text-sm mt-1">
        <div className="flex items-center gap-1 bg-gray-600 rounded p-1 justify-center">
          ...
          <span
            className={`${item.stat.attack ? 'text-white' : 'text-gray-500'} text-sm font-medium`}
          >
            +{item.stat.attack ?? 0}
          </span>
        </div>
        ...
        <div className="flex items-center gap-1 bg-gray-600 rounded p-1 justify-center">
          ...
          <span
            className={`${item.stat.magic ? 'text-white' : 'text-gray-500'} text-sm font-medium`}
          >
            +{item.stat.magic ?? 0}
          </span>
        </div>
      ...
      <div className="grid grid-cols-3 gap-1 text-sm mt-1">
        <div className="flex items-center gap-1 bg-gray-600 rounded p-1 justify-center">
          ...
          <span
            className={`${item.stat.strength ? 'text-white' : 'text-gray-500'} text-sm font-medium`}
          >
            +{item.stat.strength ?? 0}
          </span>
        </div>
        ...
        <div className="flex items-center gap-1 bg-gray-600 rounded p-1 justify-center">
          ...
          <span
            className={`${item.stat.agility ? 'text-white' : 'text-gray-500'} text-sm font-medium`}
          >
            +{item.stat.agility ?? 0}
          </span>
        </div>
        ...
        <div className="flex items-center gap-1 bg-gray-600 rounded p-1 justify-center">
          ...
          <span
            className={`${item.stat.intelligence ? 'text-white' : 'text-gray-500'} text-sm font-medium`}
          >
            +{item.stat.intelligence ?? 0}
          </span>
        </div>
        <div className="flex items-center gap-1 bg-gray-600 rounded p-1 justify-center">
          <img src="/chr.png" alt="CHR" className="w-5 h-5" />
          <span
            className={`${item.stat.charisma ? 'text-white' : 'text-gray-500'} text-sm font-medium`}
          >
            +{item.stat.charisma ?? 0}
          </span>
        </div>
        ...
        <div className="flex items-center gap-1 bg-gray-600 rounded p-1 justify-center">
          ...
          <span
            className={`${item.stat.health ? 'text-white' : 'text-gray-500'} text-sm font-medium`}
          >
            +{item.stat.health ?? 0}
          </span>
        </div>
        ...
        <div className="flex items-center gap-1 bg-gray-600 rounded p-1 justify-center">
          ...
          <span
            className={`${item.stat.wisdom ? 'text-white' : 'text-gray-500'} text-sm font-medium`}
          >
            +{item.stat.wisdom ?? 0}
          </span>
        </div>
            ...
            {equippedItem ? (
              <div>
                ...
                <p className="text-sm text-gray-500">
                  {equippedItem.description ?? '설명 없음'}
                </p>
