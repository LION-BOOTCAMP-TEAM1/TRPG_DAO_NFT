      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="max-w-3xl mx-auto mb-10">
          ...
          <button
            ...
            className="inline-block px-6 py-2 border border-fantasy-gold dark:border-[var(--fantasy-gold)] text-fantasy-gold dark:text-[var(--fantasy-gold)] hover:bg-fantasy-gold hover:text-fantasy-background dark:hover:bg-[var(--fantasy-gold)] dark:hover:text-[var(--fantasy-background)] transition-all duration-300 rounded cursor-pointer"
          >
            {ctaButtonText}
          </button>
        </div>
